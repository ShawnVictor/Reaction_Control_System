  ...
  //    int Peakcounter=0,nPeakcounter=0;
   ...
   /*  =========================================================================================
       ...
       ==========================================================================================  */
        ...
        rect(xPos-t*1,yPos-t*0.6,Width+t*1.25,Height+t*1.5, 10.0);            // outline
        ...
        rotate(-PI/2);fill(225);                                                // rotate -90 degrees
        text(yLabel,-yPos-Height/2,xPos-t*1+20);                   // y-axis Label  
        rotate(PI/2);                                                // rotate back
        
        textSize(10); noFill(); stroke(225); smooth();strokeWeight(1);
          //Edges
          ...
          if(RightAxis){                                       // Right-axis line   
           ...
           for(int x=0; x<=xDiv; x++){
            ...
            textSize(10);fill(225);                                      // x-axis Labels
          ...
          for(int y=0; y<=yDiv; y++){
            ...
            text(yAxisMS[0]+"."+yAxisMS[1].charAt(0),             // ... 
                 xPos-5,float(yDiv-y)/yDiv*Height+yPos+3);       // y-axis Labels 
